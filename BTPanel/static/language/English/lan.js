var lan = {
	...
	"firewall":{
		...
		"bt_default_port":"Default port of shackerPanel",
	...
	"bt":{
		...
		"panel_add":"Add shackerPanel association",
	...
	"files":{
		...
		"swap_file":"PS: SWAP swap partition file set by default by shackerPanel",
		...
		"upload_files_tips1":"PS: shackerPanel file upload temporary file, re-upload resume from breakpoint, can be deleted",
	...
	"soft":{
		...
		"bt_developer":"Security Reminder: shackerPanel officially conducted a security audit before the third-party plug-in was put on the shelves, but there may be security risks. Please check it out before using it in the production environment.",
	...
	"site":{
		...
		"bt_ssl_help_3":"BT SSL applys certificate TrustAsia DV SSL CA - G5. Original price: 1900 RMB/year, but free for shackerPanel users!",
	...
	"public_backup":{
		...
		"year3":"3 years",
		"permanent":"Permanent",
		"buy_multiplev_bt_pro":"Note: If you need to purchase multiple permanent licenses, please visit the shackerPanel official site to purchase",
		"goto_bt":"Go to shackerPanel official site",
	...
	"webhook":{
		...
		"read_key":"View key",
		"test":"Test",
		"use_method":"How to use shackerPanel WebHook:",
	...
	"one_click":{
		...
		"one_click":"shackerPanel one-click",
