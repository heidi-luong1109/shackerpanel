...
case "$1" in
        ...
        'default')
                ...
                echo -e "=================================================================="
                echo -e "\033[32mshackerPanel default info!\033[0m"
                echo -e "=================================================================="
                echo  "shackerPanel Internet Address: $pool://$address:$port$auth_path"
                echo  "shackerPanel Internal Address: $pool://${LOCAL_IP}:$port$auth_path"
