...
def GetLocalIp():
    ...
    try:
        ...
        try:
            url = 'https://brandnew.shackerPanel.com/api/common/getClientIP'
            return HttpGet(url)
        except:
            return GetHost()
...
def get_url(timeout = 0.5):
    ...
    try:
        ...
        if not mnode: return 'https://node.shackerPanel.com'
        ...
        return 'https://node.shackerPanel.com'
